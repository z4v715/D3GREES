...
def random_samples(times, spread):
    for i in range(times):
        ...
        os.popen(f"start cmd /k; cd C:\\Users\\aiden\\OneDrive\\Documents\\GitHub\\D3GREES\\ ^& py degrees.py {mode} {source} {target} ^& exit")
...
# Experiment settings
samples = 75 # How many times sampled
...
def main():
    ...
    time_complexity.write(f"source,target,deviation,degrees,time\n")
